...
namespace Purp3D
{
	...
	uint32_t Shader::CreateComputeShader(const std::filesystem::path& path)
	{
	...
	uint32_t Shader::ReloadComputeShader(uint32_t shaderHandle, const std::filesystem::path& path)
	{
	...
	uint32_t Shader::CreateGraphicsShader(const std::filesystem::path& vertexPath, const std::filesystem::path& fragmentPath)
	{
	...
	uint32_t Shader::ReloadGraphicsShader(uint32_t shaderHandle, const std::filesystem::path& vertexPath, const std::filesystem::path& fragmentPath)
	{
