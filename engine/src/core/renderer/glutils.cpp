...
namespace Purp3D
{
	const char* GLUtils::GLDebugSourceToString(GLenum source)
	{
		switch (source)
		{
	...
	const char* GLUtils::GLDebugTypeToString(GLenum type)
	{
		switch (type)
		{
	...
	const char* GLUtils::GLDebugSeverityToString(GLenum severity)
	{
		switch (severity)
		{
